...
function copyCode(e) {
    ...
    var a, r = e.nextElementSibling;
    l.selectNodeContents(r),
    t.removeAllRanges(),
    t.addRange(l),
    document.execCommand("copy");
    window.getSelection().removeAllRanges(),
    e.parentElement.querySelector(".alert") || ((a = document.createElement("div")).classList.add("alert", "alert-success", "position-absolute", "top-0", "border-0", "text-white", "w-25", "end-0", "start-0", "mt-2", "mx-auto", "py-2"),
...
//# sourceMappingURL=material-kit-pro.js.map
